...
| MP-08 | ✓ DONE (2026-07-04) | frontend/src/components/MixedRun.svelte, stores/workers.ts, Settings.svelte (Workers tab), internal/worker/quality.go, app.go, control/{rpc,server}.go, frontend/tests/mixed.spec.ts |
